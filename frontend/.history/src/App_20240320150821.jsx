...
const renderRoute = (path, routeTitle, routeButton, contentType, component, showSearch, showCreate, placeholder, search, redirect) => (
  <Route
    path={path}
    element={
      <>
...
function App() {
  const renderAccountRoutes = () => {
    return (
      <>
        {renderRoute('/admin/account', accountTitle, createAccountButton, contentType.list, <ListAccount />, true, true, accountTitle, search={search}, '/admin/account/create')}
