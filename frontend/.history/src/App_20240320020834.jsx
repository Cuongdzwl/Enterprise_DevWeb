...
const renderRoute = (path, routeTitle, routeButton, component, contentType) => (
  <Route
    path={path}
    element={
      <>
      ...
      <main className="App">
        ...
        <div className="Container">
          ...
          <div className="Content">
            <div className="container">
              <Routes>
                {renderRoute('/admin/account', 'list', button.create, <ListAccount />)}
                {renderRoute('/admin/create', 'create', button.create, <CreateAccount />)}
