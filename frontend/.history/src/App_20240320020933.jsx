...
const renderRoute = (path, routeTitle, routeButton, contentType, component) => (
  <Route
    path={path}
    element={
      <>
      ...
      <main className="App">
        ...
        <div className="Container">
          ...
          <div className="Content">
            <div className="container">
              <Routes>
                {renderRoute('/admin/account', 'list', button.create, contentType. <ListAccount />)}
                {renderRoute('/admin/create', 'create', null, <CreateAccount />)}
