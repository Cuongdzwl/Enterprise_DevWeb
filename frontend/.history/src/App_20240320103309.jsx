          ...
          <div className="Content">
            <div className="container">
              <Routes>
                ...
                {renderRoute('/admin/account/create', 'create', button.create, contentType.default, <CreateAccount />, false, false, '')}
                {renderRoute('/admin/account/update', 'create', button.create, contentType.default, <UpdateAccount />, false, false, '')}
