                    ...
                    <div className="box-content">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className='form-control' required name="email" value={formData.email} onChange={handleChange} />
                                <textarea name="description" cols="30" rows="10" value={formData.description} onChange={handleChange}></textarea>
