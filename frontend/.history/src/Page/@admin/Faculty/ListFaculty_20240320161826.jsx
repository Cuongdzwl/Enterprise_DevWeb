                        ...
                        <tbody>
                            {filteredFaculty.length > 0 ? (
                                filteredFaculty.map((row, index) => (
                                    <tr key={index}>
                                        <td>{row.name}</td>
                                        <td className="description" style={{ maxWidth: "208.78px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{row.descri[tion]}</td>
                                        <td className="number-event">{row.number}</td>
                                        <td>
                                            <span className={`guest-status ${row.guest === "Yes" ? "active" : ""}`}>{row.guest}</span>
                                        </td>
