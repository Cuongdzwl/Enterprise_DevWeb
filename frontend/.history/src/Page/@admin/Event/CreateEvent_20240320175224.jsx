    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            case 'name':
                ...
                break;
            case 'description':
                errorMessage = /^\S+@\S+\.\S+$/.test(value) ? '' : 'Description is invalid.';
                break;
            default:
                break;
        }
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex-row mb-input">
                                <div className="form-group">
                                    ...
                                    <input type="date" name="name" className="form-control input-date" />
                                    
                                </div>

                                <div className="form-group">
                                    <label>Due Date</label>
                                    <input type="date" name="name" id="name" className="form-control input-date" />
                                </div>
                            </div>
