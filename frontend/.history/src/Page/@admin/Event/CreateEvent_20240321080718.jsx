                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex-row mb-input">
                                <div className="form-group">
                                    ...
                                    <input type="date" required value={formData.closureDate} onChange className="form-control input-date" />

                                </div>

                                <div className="form-group">
                                    <label>Due Date</label>
                                    <input type="date" required value={formData.dueDate} className="form-control input-date" />
                                </div>
                            </div>
