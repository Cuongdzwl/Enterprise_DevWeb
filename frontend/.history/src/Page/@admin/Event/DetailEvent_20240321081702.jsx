                    ...
                    <div className="box-content">
                        <form>
                            <div className="form-group">
                                <label>Name</label>
                                <input type="text" className='form-control' readOnly name="name" value={formData.name} onChange={handleChange} />
                                {validationErrors.name && <div className="error">{validationErrors.name}</div>}
                            </div>
                            <div className="form-group">
                                <label>Description</label>
                                <textarea readOnly name="description" cols="30" rows="10" value={formData.description} onChange={handleChange}></textarea>
                            ...
                            <div className="flex-row mb-input">
                                <div className="form-group">
                                    ...
                                    <input type="date" readOnly value={formData.closureDate}
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="date"readOnly value={formData.dueDate}
