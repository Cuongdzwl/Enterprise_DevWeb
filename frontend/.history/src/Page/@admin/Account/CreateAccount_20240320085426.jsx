        ...
        <div className="box">
            <div className="box-content">
                <form onSubmit={handleSubmit}>
                    ...
                    <FormInput label="Email" type="email" name="email" value={email} onChange={(e)=> setName(e.target.value) } />
                    <FormInput label="Phone" type="text" name="phone" value={phone} onChange={handleChange} />
                    <FormInput label="Address" type="text" name="address" value={address} onChange={handleChange} />
                    <FormInput label="Role" type="select" name="role" options={roleData ? roleData.map(role => ({ value: role.name, label: role.description })) : []} value={role} onChange={handleChange} placeholder="Select Role" />
