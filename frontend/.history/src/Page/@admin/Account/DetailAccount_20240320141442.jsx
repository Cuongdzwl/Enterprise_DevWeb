        ...
        <div className="box">
            <div className="box-content">
                <form>
                    ...
                    <div className="form-group">
                        <label>Role</label>
                        <input type="text" className='form-control' readOnly value={formData.role} name="role" />
                    </div>
                    <div className="form-group mb-input">
                        <label>Faculty</label>
                        <input type="text" className='form-control' readOnly value={formData.faculty} name="faculty" />
                    </div>
