        ...
        <div className="box">
            <div className="box-content">
                <form onSubmit={handleSubmit}>
                    ...
                    <FormInput label="Role" type="select" name="role" options={roleData ? roleData.map(role => ({ value: role.name, label: role.description })) : []} value={role} onChange placeholder="Select Role" />
