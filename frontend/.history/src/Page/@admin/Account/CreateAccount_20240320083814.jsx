...
const CreateAccount = () => {
    ...
    const { data: roleData } = useMultipleFetch('http://localhost:3000/role', { method: 'GET' });
    const { data: facultyData } = useMultipleFetch('http://localhost:3000/faculty', { method: 'GET' });
