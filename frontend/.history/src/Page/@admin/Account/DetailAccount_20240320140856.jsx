        ...
        <div className="box">
            <div className="box-content">
                <form>
                    ...
                    <div className="form-group">
                        <label>Role</label>
                        <select readOnly value={formData.role} className='form-control' name="role" onChange={handleChange}>
                    ...
                    <div className="form-group mb-input">
                        <label>Faculty</label>
                        <select readOnly value={formData.faculty} className='form-control' name="faculty" onChange={handleChange}>
