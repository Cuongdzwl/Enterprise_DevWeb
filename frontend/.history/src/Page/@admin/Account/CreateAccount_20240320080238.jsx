...
const CreateAccount = () => {
    ...
    // const { data: faculty, error } = useFetch('http://localhost:3000/faculty', { method: 'GET' });
            ...
            <div className="box">
                <div className="box-content">
                    <form onSubmit={handleSubmit}>
                        ...
                        <FormInput className={`mb-input`} label="Faculty" type="select" name="faculty" options={faculties} value={formData.faculty} onChange={handleChange} placeholder="Select Faculty" />
