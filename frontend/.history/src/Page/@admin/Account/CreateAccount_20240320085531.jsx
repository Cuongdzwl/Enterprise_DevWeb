        ...
        <div className="box">
            <div className="box-content">
                <form onSubmit={handleSubmit}>
                    ...
                    <FormInput label="Role" type="select" name="role" options={roleData ? roleData.map(role => ({ value: role.name, label: role.description })) : []} value={role} onChange={(e)=> setRole(e.target.value)} placeholder="Select Role" />
                    <FormInput label="Faculty" type="select" name="faculty" options={facultyData ? facultyData.map(faculty => ({ value: faculty.name, label: faculty.description })) : []} value={faculty} onChange={(e)=> setName(e.target.value) } placeholder="Select Faculty" />
