...
function App() {
  const renderAccountRoutes = () => {
    return (
      <>
      {renderRoute('/admin/account', accountTitle, createAccountButton, listContentType, <ListAccount searchTerm={searchTerm} />, true, true, accountTitle, '/admin/account/create')}
