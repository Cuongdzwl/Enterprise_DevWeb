...
const renderRoute = (path, routeTitle, routeButton, contentType, component, showSearch={false}
  showCreate={false}) => (
  <Route
    path={path}
    element={
          ...
          <div className="Content">
            <div className="container">
              <Routes>
                ...
                {renderRoute('/admin/account/create', 'create', null, contentType.default, <CreateAccount />)}
