...
import { authenticateToken, authorizeFaculty, authorizeRole } from '../../middlewares/authentication.handler';
export default express
  ...
  .get('/:id',authenticateToken,authorizeRole("admin,manager"), controller.byId)
